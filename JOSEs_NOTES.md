...
./inventoryctl.py host -n rtr0 -H rtr0.example.com -v ansible_host 10.0.255.255 -g iosxr -e 1
./inventoryctl.py host -n rtr1 -H rtr1 -v ansible_host 1.1.1.1 -g ios -e 1
./inventoryctl.py host -n swt1 -H swt1 -v ansible_host 2.2.2.2 -g nxos -e 1
